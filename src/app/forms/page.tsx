...
<script>
  MiWibi.initForm({
    ...
    const previewThemeClasses = useMemo(() => {
        ...
        return {
            shell: 'bg-white border-border shadow-[0_24px_60px_rgba(23,23,23,0.08)]',
            title: 'text-[#171717]',
            description: 'text-[#62594b]',
            label: 'text-[#4d473c]',
            input: 'bg-muted border-border text-[#171717]',
            placeholder: 'text-[#8a816f]',
            footer: 'text-[#746b58]',
        };
    }, [styleConfig.theme]);
        ...
        return (
            <div className="max-w-7xl mx-auto space-y-8 animate-in fade-in duration-700">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {forms.map(f => (
                        <div key={f.id} className="bg-white border border-border rounded-2xl shadow-sm p-6 space-y-5 group hover:border-primary/40 transition-all">
                            <div className="flex justify-between items-start">
                                ...
                                <div className="flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                    <button
                                        ...
                                        className="p-2.5 bg-muted border border-border rounded-xl hover:bg-primary hover:text-black hover:border-primary transition-all"
                                    >
                            ...
                            <div>
                                ...
                                <div className="flex items-center gap-3 mt-2">
                                    <span className="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-bold bg-emerald-500/10 text-emerald-600">{f.submissions} Leads</span>
                                    <span className="text-xs text-muted-foreground">Creado: {new Date(f.createdAt).toLocaleDateString()}</span>
                                </div>
                            </div>
                        </div>
                    ))}
                    {forms.length === 0 && (
                        <div className="col-span-full py-24 text-center bg-white border border-dashed border-border rounded-2xl">
                            <p className="text-sm font-semibold text-muted-foreground">No hay formularios creados aún</p>
                        </div>
                    )}
                </div>
            </div>
    ...
    return (
        <div className="max-w-7xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    <h1 className="text-2xl font-black text-foreground tracking-tight">Formbuilder IA</h1>
                ...
                <div className="flex items-center gap-3">
                    <button
                        ...
                        className="bg-white border border-border text-foreground font-semibold rounded-xl px-4 py-2.5 hover:bg-muted transition-all flex items-center gap-2"
                    >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                    ...
                    <div className="bg-white border border-border rounded-2xl shadow-sm p-6 space-y-6">
                        ...
                        {activeEditorTab === 'config' ? (
                            <>
                                <div className="space-y-3">
                                    <label className="block text-xs font-bold uppercase tracking-wide text-foreground mb-1.5 flex items-center gap-2">
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-center justify-between border-b border-border pb-3">
                                        <h3 className="text-xs font-bold uppercase text-foreground tracking-wide flex items-center gap-2">
                                        ...
                                        {Object.entries(captureFields).map(([key, val]) => (
                                            <div
                                                ...
                                                className={clsx(
                                                    ...
                                                    val.active ? "bg-primary/8 border-primary/35 text-primary" : "bg-muted border-border text-muted-foreground hover:border-border/80"
                                                )}
                                            >
                                                <div className="flex items-center gap-3">
                                                    {val.active ? <CheckCircle2 className="w-4 h-4" /> : <Circle className="w-4 h-4" />}
                                                    <span className="text-xs font-bold">
                                                        {val.label}
                                                    </span>
                                                </div>
                                                <span className="text-[10px] font-bold uppercase tracking-widest opacity-50">{val.active ? 'Requerido' : 'Apagado'}</span>
                                            </div>
                                        ))}
                                    </div>
                                </div>
                            ...
                            <div className="space-y-6 animate-in fade-in zoom-in-95 duration-300">
                                        ...
                                        {[
                                            ...
                                            <button
                                                ...
                                                className={clsx(
                                                    ...
                                                    styleConfig.theme === theme.id ? "bg-primary/10 border-primary text-primary" : "bg-muted border-border text-foreground/70 hover:text-foreground hover:border-border/80"
                                                )}
                                            >
                                                <theme.icon className="w-4 h-4" />
                                                <p className="text-[10px] font-bold uppercase leading-tight">{theme.label}</p>
                                            </button>
                                        ))}
                                    </div>
                                </div>
                                ...
                                <div className="space-y-3">
                                    <label className="block text-xs font-bold uppercase tracking-wide text-foreground mb-1.5">Color de Marca</label>
                                    <div className="flex items-center gap-3">
                                        <input
                                            type="color"
                                        ...
                                        <input
                                            ...
                                            value={formConfig.primaryColor}
                                            onChange={(e) => setFormConfig({ ...formConfig, primaryColor: e.target.value })}
                                            className="flex-1 bg-muted border border-border rounded-xl px-3 py-2.5 text-sm outline-none focus:border-primary focus:bg-white transition-all font-mono uppercase"
                                        />
                                    </div>
                                </div>

                                <div className="space-y-3">
                                    <label className="block text-xs font-bold uppercase tracking-wide text-foreground mb-1.5">Bordes y Ángulos</label>
                                    <div className="flex gap-2">
                                        {['0.5rem', '1.5rem', '3rem'].map((r) => (
                                            <button
                                                ...
                                                className={clsx(
                                                    "flex-1 py-2.5 border rounded-xl transition-all text-xs font-bold",
                                                    styleConfig.corners === r ? "bg-primary/10 border-primary text-primary" : "bg-muted border-border text-foreground/70 hover:text-foreground"
                                                )}
                                            >
                        ...
                        <div className="p-4 bg-emerald-500/5 border border-emerald-500/20 rounded-xl space-y-2">
                            <div className="flex items-center gap-2 text-emerald-600">
                                ...
                                <h4 className="text-xs font-bold uppercase tracking-wide">Smart Adaptation</h4>
                            </div>
                        ...
                        <button
                            ...
                            className="w-full bg-primary text-black font-bold rounded-xl px-4 py-2.5 hover:brightness-105 transition-all flex items-center justify-center gap-2"
                        >
                ...
                <div className="lg:col-span-8 flex flex-col gap-6">
                    <div className="flex bg-muted border border-border p-1 rounded-xl w-fit">
                        <button
                            onClick={() => setPreviewTab('preview')}
                            className={clsx(
                                "flex items-center gap-2 px-4 py-2 rounded-lg text-xs font-bold transition-all",
                                previewTab === 'preview' ? "bg-primary text-black shadow-sm" : "text-muted-foreground hover:text-foreground"
                            )}
                        >
                        ...
                        <button
                            ...
                            className={clsx(
                                "flex items-center gap-2 px-4 py-2 rounded-lg text-xs font-bold transition-all",
                                previewTab === 'qr' ? "bg-primary text-black shadow-sm" : "text-muted-foreground hover:text-foreground"
                            )}
                        >
                        ...
                        <button
                            ...
                            className={clsx(
                                "flex items-center gap-2 px-4 py-2 rounded-lg text-xs font-bold transition-all",
                                previewTab === 'code' ? "bg-primary text-black shadow-sm" : "text-muted-foreground hover:text-foreground"
                            )}
                        >
                    ...
                    <div className="bg-white border border-border rounded-2xl shadow-sm p-6 lg:p-8 flex items-center justify-center min-h-[560px]">
                        {previewTab === 'preview' ? (
                            <div
                                style={{
                                ...
                                className={clsx(
                                    "w-full max-w-[42rem] p-6 lg:p-10 transition-all duration-700 border animate-in zoom-in-95 duration-500",
                            ...
                            >
                                <div className="space-y-4">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className={clsx("mt-2 text-sm font-medium", previewThemeClasses.description)}>{formConfig.description}</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="pt-7">
                                    ...
                                    <p className={clsx("mt-5 text-[9px] text-center font-black uppercase tracking-[0.22em] flex items-center justify-center gap-2", previewThemeClasses.footer)}>
                            ...
                            <div className="w-full max-w-lg bg-white border border-border rounded-2xl shadow-sm p-10 lg:p-14 animate-in zoom-in-95 duration-500 text-center">
                                {!savedFormId ? (
                                    <div className="space-y-6">
                                        ...
                                        <h3 className="text-xl font-black text-foreground tracking-tight">Generador de Código QR</h3>
                                    ...
                                    <div className="space-y-8">
                                        <div className="space-y-1">
                                            <h3 className="text-xl font-black text-foreground tracking-tight">Acceso Instantáneo</h3>
                                            <p className="text-xs font-bold text-emerald-600 uppercase tracking-widest">Vinculado a: {formConfig.title}</p>
                                        </div>

                                        <div className="p-6 bg-white border border-border rounded-2xl shadow-sm inline-block group relative">
                                            <img
                                                src={qrUrl}
                                                alt="QR Code"
                                        ...
                                        <div className="space-y-3">
                                            <div className="p-3 bg-muted border border-border rounded-xl flex items-center justify-between gap-4 group/url">
                                                <code className="text-xs text-muted-foreground truncate flex-1 block text-left">{publicUrl}</code>
                                                <button
                                                    onClick={() => {
                                                    ...
                                                    className="p-2 bg-white border border-border rounded-lg hover:bg-primary hover:text-black hover:border-primary transition-all"
                                                >
                            ...
                            <div className="w-full max-w-2xl bg-white border border-border rounded-2xl shadow-sm p-8 lg:p-10 animate-in slide-in-from-right-4 duration-500">
                                <div className="flex items-center justify-between mb-6">
                                    <div className="space-y-1">
                                        <h3 className="text-lg font-black text-foreground tracking-tight">Integración Rápida</h3>
                                        <p className="text-xs text-muted-foreground">Copia y pega este código en tu sitio web</p>
                                    </div>
                                    <div className="flex items-center gap-1 p-1 bg-muted border border-border rounded-xl">
                                        <button className="px-3 py-1.5 text-xs font-bold text-foreground bg-white border border-border rounded-lg shadow-sm">SDK (JS)</button>
                                        <button className="px-3 py-1.5 text-xs font-bold text-muted-foreground hover:text-foreground transition-colors">HTML / IFRAME</button>
                                    </div>
                                </div>

                                <div className="relative group/code">
                                    <pre className="bg-muted border border-border rounded-xl p-6 text-xs font-mono leading-relaxed overflow-x-auto text-foreground">
                                    ...
                                    <button
                                        ...
                                        className="absolute top-3 right-3 bg-primary text-black p-2.5 rounded-xl hover:scale-110 active:scale-95 transition-all opacity-0 group-hover/code:opacity-100 shadow-sm"
                                    >
                                        <Copy className="w-4 h-4" />
                                    </button>
                                </div>

                                <div className="mt-6 p-4 bg-muted border border-border rounded-xl flex items-start gap-4">
                                    <div className="p-2.5 bg-sky-500/10 rounded-xl">
                                        <Globe2 className="w-4 h-4 text-sky-500" />
                                    </div>
                                    <div className="space-y-1">
                                        <p className="text-xs font-black text-foreground uppercase tracking-wide">Despliegue Instantáneo</p>
                                        <p className="text-xs text-muted-foreground leading-relaxed">
