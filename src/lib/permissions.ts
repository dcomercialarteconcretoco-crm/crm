...
export const DEFAULT_PERMISSIONS: Record<string, Record<string, boolean>> = {
  ...
  // Auditor: rol de solo-auditoría (Cliente Oculto + Auditoría de Gestión).
  // NO ve clientes, cotizaciones ni pipeline — su trabajo es evaluar el
  // proceso comercial de incógnito, así que no debe poder tocar datos
  // comerciales ni aparecer operando frente a los vendedores.
  Auditor: {
    'quotes.view': false,
    'quotes.create': false,
